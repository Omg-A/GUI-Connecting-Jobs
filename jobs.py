...
place_image.place(relx=0.75, rely=0.5,anchor=CENTER)

label = Label(root, text="Assigning Jobs", font=("", 20, "bold"), fg="#1763A5")
...
entry_doctor.place(relx=0.136, rely=0.15,anchor=CENTER)

entry_IT = Entry(root)
entry_IT.place(relx=0.178, rely=0.45,anchor=CENTER)

entry_chemical = Entry(root)
entry_chemical.place(relx=0.2, rely=0.75,anchor=CENTER)
